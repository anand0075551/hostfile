...
//For Transaction Series	
	...
	public function make_my_payment($pay_by_referral_code, $pay_to_referral_code, $amount_to_pay, $pay_spec_type, $transaction_remarks, $pm_mode){
...
$acct_user 		= $c_id;
$result_count  	= $this->payment_model->get_tran_count($acct_user);
...
/*	Get user Balance and Update Final Amount */
		...
		$user_balance  	= $this->payment_model->user_balance($bal_userID, $points_mode);
	...
	//Sender/Seller/Active user
								...
								$user_debit  	= $this->payment_model->total_debit($userID, $points_mode);
								$user_credit  	= $this->payment_model->total_credit($userID, $points_mode);
