...
class Instant_payment_model extends CI_Model {
...
//For Transaction Series	
	...
	public function make_instant_payment(){
		...
		$amount	    		= $this->input->post('amount');		//Paying Amount	
		$paid_by			= $user_referral_code;		//Paying By Consumer ID			
		$pay_type   		= $this->input->post('business_type');   //Pay Specification
...
$acct_user 		= $c_id;
$tran_count     = '0';
$result_count  	= $this->instant_payment_model->get_tran_count($acct_user);		
...
/*	Get user Balance and Update Final Amount */
		...
		$user_balance  	= $this->instant_payment_model->user_balance($bal_userID, $points_mode);
	...
	//Sender/Seller/Active user
								...
								$user_debit  	= $this->instant_payment_model->total_debit($userID, $points_mode);
								$user_credit  	= $this->instant_payment_model->total_credit($userID, $points_mode);
...
/***********************************************************************************************/	
/* Processing Voucher on Rare Case												   */
/* 																							   */
/*																							   */
/***********************************************************************************************/
//Process for Voucher creation If Role is Event Manager, Recieving party will get Vouchers instead of Money sender
if ($seller_role == '39')
{
	
	$voucher  	= $this->vouchers_model->get_voucher_event($c_id, $total_price, $pay_type);		
}		
