...
<?php foreach($places1->result() as $places)  ?>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Favourite Places</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                ...
                <div class="form-group <?php if (form_error('business_name')) echo 'has-error'; ?>">
								...
								<div class="col-md-9">  								
									...
									<select name="type14" id="type" class="form-control" >
										<option value="<?php echo $places->type;?>">
										
										<?php 
										$get = $this->db->group_by('type')->get_where('per_favourite_places');
										$get = $this->db->get_where('per_favourite_places',['type'=> $places->type]);
				...
				<div class="form-group <?php if (form_error('text10')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
						<input type="text" name="text10" id="text10" class="form-control" value="<?php echo $places->text1;?>" placeholder="Enter Text1">	                                
				...
				<div class="form-group <?php if (form_error('text11')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
						<input type="text" name="text11" id="text11" class="form-control" value="<?php echo $places->text2;?>" placeholder="Enter Text2">	                                
				...
				<div class="form-group <?php if (form_error('text12')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
						<input type="text" name="text12" id="text12" class="form-control" value="<?php echo $places->text3;?>" placeholder="Enter Text3">	                                
            ...
            <div class="box-footer">
                <button type="submit" name="submit" value="edit_places" class="btn btn-primary">
                    <i class="fa fa-edit"></i> Update
                </button>
					<button type="submit" name="submit" value="copy_place" class="btn btn-primary">
                    <i class="fa fa-copy"></i> Copy
                </button> 
				
			 <a href="<?php echo base_url('Personal_info/list_favourite_places') ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i>Back</a>	
