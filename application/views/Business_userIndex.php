        ...
        <div class="col-md-12">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">All Customer List at ShopMyBasket Portal</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
    ...
    <script type="text/javascript">
        $(function() {
            $("#example").dataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "<?php echo base_url('Business_module/alluserListJson'); ?>"
            });
        });
...
<script>
    ...
    $('body').on('click', 'a.deleteBtn', function () {
        ...
        if(verifyConfirm) {
            $.ajax({
                type: "POST",
               // url: "<?php echo base_url('Business_module/deleteAjax') ?>",
				   url: "<?php echo base_url('Business_module/processAjax') ?>",
                data: {id: agentId},
            })
            .done(function (msg) {
    ...
    $('body').on('click', 'button.blockUnblock', function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('Business_module/setBlockUnblock') ?>",
