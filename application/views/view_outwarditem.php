        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="form-group">
                   ...
                   <br>
                    ...
                    <div class="form-group">
                          ...
                          <label class="col-md-2  col-sm-3 col-xs-7 control-label">To whom</label>  
                            <div class="col-md-4 col-sm-3 col-xs-5 inputGroupContainer">
                            <div class="input-group">
                            <?php echo $profile->to_whom; ?>
                            </div>
                          </div>
					</div>
                     <br>
                    <div class="form-group">
                          <label class="col-md-2 col-sm-3 col-xs-7 control-label">From Sender</label>  
                            <div class="col-md-4 col-sm-3 col-xs-5 inputGroupContainer">
                            <div class="input-group">
                              <?php echo $profile->from_sender; ?>
                            </div>
                          </div>
               ...
               <div class="box-footer">
                     <a href="<?php echo base_url('Visitor_entry/outward_item_list') ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i>Back</a>
...
//							$rolename    = singleDbTableRow($user_id)->rolename;
				...
				<a href="<?php echo base_url('Visitor_entry/edit_outward_items/' . $profile->id) ?>" class="btn btn-primary"><i class="fa fa-arrow-edit"></i>Edit</a>
...
<script>
	...
	function createPDF(){
		getCanvas().then(function(canvas){
			...
			doc.save('Visitor Outward Entry Details.pdf');
