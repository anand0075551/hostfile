	...
	<div class="col-md-12">
		...
		<input type="hidden" id="sen_id" value="<?php echo $id->id; ?>" />
			<div class="box-header"> 
				<h3 class="box-title"> Acceted Role </h3>
			</div><!-- /.box-header -->
				<div class="box-body">
				...
				<div class="text-right">
					<button type="button" class="btn btn-danger"  id="cancel_btn" data-dismiss="modal" onClick="window.location.reload();" >Cancel</button>
				</div>
			</form>
		</div><!-- /.box -->
	</div><!--/.col (left) -->
