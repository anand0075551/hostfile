                ...
                <?php echo form_open_multipart('', ['create' => 'form', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']); ?>
                    ...
                    <div class="form-group <?php if (form_error('categ')) echo 'has-error'; ?>">
                    	...
                    	<div class="form-group <?php if (form_error('organiser')) echo 'has-error'; ?>">
								...
								<input type="text" class="form-control" value="<?php echo $organiser;?>">	                                
                            ...
                            (This row will not be saved unless you click on "Add" first)
                                                ...
                                                <?php if (!empty($e->selected_bg) && !empty($e->selected_area)) {?>
                                                 ...
                                                 <td>Business Group</td>
                                                    ...
                                                    <tr>
                                                    <td>
                                                     <input type="text"  class="form-control" value="<?php echo singleDbTableRow($bgs, 'business_groups')->business_name;?>"/>
                                                    <input type="hidden" name="sbg[]" class="form-control" value="<?php echo $bgs;?>"/>
                                                    </td>
                                                    </tr>
                                                <?php }?>
														...
														foreach($explode_area as $area)
							 								{
																$er =singleDbTableRow($area, 'area')->location;
								 								$e_area =singleDbTableRow($er, 'location_id')->location;
														  ?>
                                                          <tr>
                                                    <td>
                                                    <input type="text"  class="form-control" value="<?php echo $e_area;?>"/>
                                                    <input type="hidden" name="sarea[]" class="form-control" value="<?php echo $area;?>"/></td>
                                                    </tr>
                                                          <?php } ?>
                                    </table>
                                    <?php } ?>
											...
											$selected_roles = rtrim($e->selected_roles,", ");
													...
													foreach($explode_role as $rl)
														{ ?>
                                <option value="<?php echo $rl;?>" selected> <?php echo $rl .'-'. singleDbTableRow($rl, 'role')->rolename;?>  </option>
														<?php }
												?>
                        ...
                        <div class="form-group <?php if (form_error('host')) echo 'has-error'; ?>">
								...
								<div class="col-md-9"> 
                                 <input type="hidden" name="host" id="host" class="form-control" value="<?php echo $e->host;?>"> 								
                        ...
                        <div class="form-group <?php if(form_error('clables')) echo 'has-error'; ?>">
                           ...
                           <strong> To :   </strong><select name="sponsor_to" id="sponsor_to" class="form-control"  style="width:555px"><br>
                            ...
                            (This row will not be saved unless you click on "Add" first)<br>
                             <?php if (!empty($sponsorships) && $sponsorships->num_rows() > 0) {?>
                             <table class="table table-striped">
                             <tr>
                             <td>For</td>
                             <td>Charge</td>
                             <td>To</td>
								...
								<?php foreach ($sponsorships->result() as $sps){
								?>
                                <tr>
                                <td><input type="text" name="sfor[]" class="form-control" value="<?php echo $sps->title;?>"/></td>
                                <td><input type="text" name="scharge[]" size="4" class="form-control" value="<?php echo $sps->charge;?>"/></td>
                                <td><select name="sto[]" id="sto[]" class="form-control" ><br>
										<option value="<?php echo $sps->give_to;?>"> <?php echo singleDbTableRow($sps->give_to, 'users')->first_name.' '.singleDbTableRow($sps->give_to, 'users')->last_name;?>  </option>
										<?php
										if ($users->num_rows() > 0) 
										{
											foreach ($users->result() as $user) 
                        ...
                        <div class="form-group <?php if (form_error('status')) echo 'has-error'; ?>">
								...
								<div class="col-md-9">  								
									<select name="status" id="status" class="form-control" >
										...
										<option value="0" <?php if($e->status ==0) {  ?> selected<?php }?>> Inactive</option>
                                        <option value="1"<?php if($e->status ==1) {  ?> selected<?php }?>> Active</option>
										<option value="2"<?php if($e->status ==2) {  ?> selected<?php }?>> Closed</option>	
									</select>	                                
				...
				<div class="clearfix"></div>
                    ...
                    <div class="box-footer">
                  		<button type="submit" name="submit" value="edit" class="btn btn-primary">
                            <i class="fa fa-plus"></i> Update Now
                        </button>
