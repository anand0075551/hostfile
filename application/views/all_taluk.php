        ...
        <div class="col-md-12">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Taluk List</h3>
                </div><!-- /.box-header -->
...
<i class fa fa-credit-card"></i> Download Taluk </button>
<br>
<br>
    ...
    <script type="text/javascript">
        $(function() {
            $("#example").dataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "<?php echo base_url('location/talukListJson'); ?>"
            });
        });
...
<script>
    ...
    $('body').on('click', 'a.deleteBtn', function () {
        ...
        if(verifyConfirm) {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('location/deleteAjax3') ?>",
                data: {id: agentId},
            })
            .done(function (msg) {
