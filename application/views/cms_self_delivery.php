...
<input type="hidden" name="to_role" class="form-control" value="<?php echo $to_role; ?>">
		...
		?>
						...
						<hr>
				<div class="form-group <?php if(form_error('shipping_cost')) echo 'has-error'; ?>" style=display:none;>
                            <label for="exampleInputEmail1" class="col-md-3">Declared Charge
                                <span class="text-red">*</span>
                            </label>
                            <div class="col-md-9">
                 <input type="number" id="avi_stock" class="form-control" readonly value="<?php echo $res->cost; ?>">
				...
				<div class="form-group <?php if(form_error('shipping_cost')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">
                 <input type="text" name="shipping_cost"  class="form-control" onkeyup="get_que(this.value)" value="">
                                <?php echo form_error('shipping_cost') ?>
...
<hr>
				...
				<div class="form-group <?php if(form_error('shipping_cost')) echo 'has-error'; ?>" style=display:none;>
                            ...
                            <div class="col-md-9">
                 <input type="number" id="avi" class="form-control" readonly value="<?php echo $res->cost; ?>">
                                <?php echo form_error('shipping_cost') ?>
				...
				<div class="form-group <?php if(form_error('shipping_cost')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">
                 <input type="text" name="shipping_c"  class="form-control" onkeyup="get_q(this.value)" value="">
                                <?php echo form_error('shipping_cost') ?>
