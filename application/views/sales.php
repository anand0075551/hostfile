        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary boxFormContainer">
                <div class="box-header">
                    <h3 class="box-title">New Sales Transaction</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <?php echo form_open_multipart('', ['role' => 'form', 'class' => 'form-horizontal']); ?>
                    ...
                    <div class="box-footer"> <!--path:  product/ add_sales -->
                        <button type="submit" name="submit" value="add_sales" class="btn btn-primary">
