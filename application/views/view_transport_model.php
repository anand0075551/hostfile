        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
               ...
               <div class="box-footer">
                    <a href="<?php echo base_url('Transport/model_transport_index') ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i>Back</a>
...
//							$rolename    = singleDbTableRow($user_id)->rolename;
				...
				<a href="<?php echo base_url('Transport/edit_transport_model/' . $profile->id) ?>" class="btn btn-primary"><i class="fa fa-arrow-edit"></i>Edit</a>
