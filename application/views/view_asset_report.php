        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                    ...
                    <table class="table table-striped">
					    <tr>
                            ...
                            <td><?php echo $profile->role; ?></td>
									...
									<tr>
										<td>Visitor Id</td>
										<td><?php echo $profile->visitor_id; ?></td>
									</tr>
							...
							<tr>
                                <td>Assigned To</td>
                                <td><?php echo $fname = singleDbTableRow($profile->assigned_to)->first_name . ' ' . singleDbTableRow($profile->assigned_to)->last_name; ?></td>
                            </tr>
               ...
               <div class="box-footer">
                    <a href="<?php echo base_url('Visitor_entry/assete_history_report') ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i>Back</a>
