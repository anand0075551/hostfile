    ...
    <body class="skin-blue">
        ...
        <div class="form-box" id="login-box">
            <!-- <div class="header"><i class="fa  fa-sign-in"></i> Consumer1st Sign In</div>-->
			  <div class="header"><i class="fa  fa-group"></i> Consumer1st Sign In</div>
            <?php echo form_open(); ?>
...
<a href="<?php echo base_url('welcome/registerUser') ?>" class="text-center"><i class="fa fa-plus-square-o"></i> Register with Consumer1st </a>
					<br><br>
