                            ...
                            <div class="form-group <?php if (form_error('pay_type')) echo 'has-error'; ?>">
								...
								<div class="col-md-9">  								
									...
									<select name="pay_type" id="pay_type" class="form-control" >
										<option value="<?php echo $distributor_commission->pay_type;?>"> <?php echo $distributor_commission->pay_type ?> </option>
                        ...
                        <div class="col-md-9">  								
                            ...
                            <select name="to_user" class="form-control" id="to_user">
                                <option value=""> -Select User-</option>
									<?php 
										$get = $this->db->order_by('first_name','asc')->get_where('users', ['rolename'=>$distributor_commission->to_role]);
										foreach($get->result() as $ac)
										{?> 
                                        <option value="<?php echo $ac->id;?>"> <?php echo $ac->contactno.'-'.$ac->first_name.' '.$ac->last_name;?></option>
										<?php } ?>
