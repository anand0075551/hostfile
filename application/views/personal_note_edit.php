			 ...
			 <div class="box-header">
                  ...
                  <?php echo form_open_multipart('', ['create' => 'form', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']); ?>
                   ...
                   <div class="form-group <?php if(form_error('p_date')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">
                         <input type="text" class="some_class"  id="some_class_1" name="p_date"  class="form-control" value="<?php echo $n->p_date;?>"/>
                     ...
                     <div class="form-group <?php if(form_error('title')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="title" id="title" class="form-control" value="<?php echo $n->title;?>">
                    ...
                    <div class="form-group <?php if(form_error('description')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">
                            <textarea name="description" id="description" class="form-control"><?php echo $n->description;?></textarea>
                     ...
                     <div class="form-group <?php if(form_error('note1')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">
                            <textarea name="note1" id="note1" class="form-control"><?php echo $n->note1;?></textarea>
                    ...
                    <div class="form-group <?php if(form_error('note2')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">
                            <textarea name="note2" id="note2" class="form-control"><?php echo $n->note2;?></textarea>
                    ...
                    <div class="form-group <?php if(form_error('note3')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">
                            <textarea name="note3" id="note3" class="form-control"><?php echo $n->note3;?></textarea>
                    ...
                    <div class="form-group <?php if(form_error('note4')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">
                            <textarea name="note4" id="note4" class="form-control"><?php echo $n->note4;?></textarea>
                    ...
                    <div class="form-group <?php if(form_error('note5')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">
                            <textarea name="note5" id="note5" class="form-control"><?php echo $n->note5;?></textarea>
