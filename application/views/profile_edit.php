        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">
					<?php echo 'Consumer Name :'.$c_user->first_name.' '. $c_user->last_name; ?></h3>
                        ...
                        <div class="form-group <?php if(form_error('date_of_birth')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" readonly name="date_of_birth" type="text" value="<?php echo $c_user->date_of_birth; ?>" data-mask="" data-inputmask="'alias': 'yyyy-mm-dd'">
                                </div>
                                <?php echo form_error('date_of_birth') ?>
                            </div>
                        </div>
<?php }else{ ?>	<!-- Only for Agent Group -->
						<div class="form-group <?php if(form_error('company_name')) echo 'has-error'; ?>">
                            <label for="firstName" class="col-md-3">Firm Name</label>
                            <div class="col-md-9">
                                <input type="text" name="company_name" readonly class="form-control" value="<?php echo $c_user->company_name; ?>" >
						...
						<div class="form-group <?php if(form_error('licence')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="licence" readonly class="form-control" value="<?php echo $c_user->licence; ?>" >
							   ...
							   { ?> 
									<div class="form-group < ?php if(form_error('role')) echo 'has-error'; ?>">
										...
										<div class="col-md-9">
											 ...
											 <td> < ?php 
												$userInfo = singleDbTableRow($c_user->rolename, 'role');
												$roleName = $userInfo->rolename;
												echo ucwords($roleName);  ?></td>
...
-->
						...
						<div class="form-group <?php if(form_error('city')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="city" value="<?php echo $c_user->city; ?>" class="form-control" placeholder="City/Village Name">
					...
					<!-- User/ public function profile_edit($id = 0)&& user_model->profile_update($id); -->
