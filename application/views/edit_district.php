                ...
                <?php echo form_open_multipart('', ['role' => 'form', 'class' => 'form-horizontal']); ?>
                    <div class="box-body">
						...
						<div class="form-group <?php if(form_error('statename')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">  								
                                    <input type="text" name="statename" readonly class="form-control" value="<?php  $district->statename; 
						...
						<div class="form-group <?php if(form_error('districtname')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">  								
                                    <input type="text" name="districtname" class="form-control" value="<?php echo $district->districtname;?>" placeholder="Enter District Name">                                
                    ...
                    <div class="box-footer">
                        <button type="submit" name="submit" value="edit_district" class="btn btn-primary">
                            <i class="fa fa-edit"></i>Update
                        </button>
						<a href="<?php echo base_url('location/view_district/'.$district->id) ?>" class="btn btn-primary"><i class="fa fa-edit"></i> Cancel</a>
