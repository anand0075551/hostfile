    ...
    <div class="fila">
      ...
      <div class="seccion">
        <div class="asiento">
          ...
          <label for="asiento19">22</label>
        </div>
        <div class="asiento">
          <input type="checkbox" value="None" id="asiento23" name="check" />
          <label for="asiento20">23</label>
        </div>
      </div>
    </div>
    ...
    <div class="fila">
      ...
      <div class="seccion">
        <div class="asiento">
          ...
          <label for="asiento19">25</label>
        </div>
        <div class="asiento">
          <input type="checkbox" value="None" id="asiento26" name="check" />
          <label for="asiento20">26</label>
        </div>
      </div>
    </div>
    ...
    <div class="fila">
      ...
      <div class="seccion">
        <div class="asiento">
          ...
          <label for="asiento19">28</label>
        </div>
        <div class="asiento">
          <input type="checkbox" value="None" id="asiento29" name="check" />
          <label for="asiento20">29</label>
        </div>
      </div>
    </div>
    ...
    <div class="fila">
      ...
      <div class="seccion">
        <div class="asiento">
          ...
          <label for="asiento23">33</label>
        </div>
        <div class="asiento">
          <input type="checkbox" value="None" id="asiento34" name="check" />
          <label for="asiento24">34</label>
        </div>
