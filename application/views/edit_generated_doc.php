                  ...
                  <?php echo form_open_multipart('', ['create' => 'form', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']); ?>
                   ...
                   <div class="form-group <?php if(form_error('role')) echo 'has-error'; ?>">
                        ...
                        <div class="form-group <?php if(form_error('fname')) echo 'has-error'; ?>">
								...
								<div class="col-md-9"> 
                                <input type="text"   id="fname" name="fname" value="<?php echo $generate_doc->file_name; ?>" class="form-control"/> 								
                    ...
                    <!--File -->
                   		<div class="form-group <?php if(form_error('userfile')) echo 'has-error'; ?>">
								...
								<div class="col-md-9"> 
                                <textarea id="editor1" name="userfile" rows="10" cols="80"><?php echo $generate_doc->userfile; ?></textarea> 								
                    ...
                    <div class="form-group <?php if(form_error('status')) echo 'has-error'; ?>">
					  ...
					  <div class="box-footer">
                  		<button type="submit" name="submit" value="edit_generated_doc" class="btn btn-primary">
