                ...
                <?php echo form_open_multipart('', ['role' => 'form', 'class' => 'form-horizontal']); ?>
                    <div class="box-body">
						 ...
						 <div class="form-group <?php if(form_error('country')) echo 'has-error'; ?>">
                            <label for="firstName" class="col-md-3">State</label>
                            <div class="col-md-9">
							<script>
							   function getState(Stateid)
							   {
								   var mydata = {"stateid":stateid};
								   $.ajax({
									   type:"POST",
									   url:"getstate",
									   data:mydata,
									   success:function(response){
										 $("#shipper_state").html(response);
									   }
								   });
							   }
							</script>
							<span id="spryselect_acctype">
                        <select name="statename" class="form-control" onChange="getDistrict(this.value)">
							<option value="">Choose Option</option>
							<?php 
							foreach($state as $dt){
								if($dt->statename !=""){
									echo "<option value=".$dt->id.">".$dt->statename."</option>";
								}
							}
							?>
                        </select>	
							<?php echo form_error('state') ?>
							<span class="selectRequiredMsg">Please select shipper country.</span>
                    </span>
						</div>
						</div>
						...
						<div class="form-group <?php if(form_error('districtname')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">  								
                                    <input type="text" name="districtname" class="form-control" value="<?php echo set_value('districtname'); ?>" placeholder="Enter State Name">                                
                    ...
                    <div class="box-footer">
                        <button type="submit" name="submit" value="add_district" class="btn btn-primary">
