        ...
        <div class="col-md-12">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Transaction/Invoice List</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<input type="hidden" id="showFor" value="<?php echo $this->uri->segment(3); ?>">
    ...
    <script type="text/javascript">
        $(function() {
            $("#example").dataTable({
                ...
                "ajax": {
                    "url": "<?php echo base_url('account/earningSingleUserJson'); ?>",
                    "data": function ( d ) {
                        //d.myKey = "myValue";
