                    ...
                    <table id="example" class="table table-bordered table-striped table-hover">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th width="10%">Voucher price</th>
                                <th width="10%">Pay Type</th>
								<th width="10%">Pay Type To</th>
                                <th width="10%">Voucher Owner Role</th>
                                <th width="10%">Reciever Role</th>
    ...
    <script type="text/javascript">
            $(function () {
                $("#example").dataTable({
                    "processing": true,
                    "serverSide": true,
                    "ajax": "<?php echo base_url('Food_voucher/foodvoucherListJson'); ?>"
                });
            });
   ...
   < <script>
		$('body').on('click', 'a.deleteBtn', function () {
            ...
            if (verifyConfirm) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('Food_voucher/deleteAjax') ?>",
                    data: {id: agentId},
                })
                        .done(function (msg) {
