				...
				<!--	<h4 class="box-title">Available Balance as on <?php echo date('Y-m-d h-i-s') ?> to Generate/Purchase Vouchers</h4>	 -->		
					...
					<table id="deposit" class="table table-bordered table-striped table-hover">
						...
						<div class="form-group <?php if(form_error('amount')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">
                                <input type="number" name="amount"  id="amount" readonly class="form-control" max="<?php echo $commissions->amount; ?>" value="<?php echo $commissions->amount; ?>" >
						...
						<div class="form-group <?php if(form_error('amount')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">
                                <input type="number" name="amount"  id="amount" readonly  class="form-control" max="<?php echo $commissions->loy_amt; ?>" value="<?php echo $commissions->loy_amt; ?>" >
                                <?php echo form_error('amount') ?>
                            </div>
                        </div>
												<div class="form-group <?php if(form_error('amount')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">
                                <input type="number" name="amount"  id="amount" readonly class="form-control" max="<?php echo $commissions->dis_amt; ?>" value="<?php echo $commissions->dis_amt; ?>" >
                                <?php echo form_error('amount') ?>
                            </div>
                        </div>
						...
						<div class="form-group <?php if(form_error('trans_type')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">    	
										<input type="radio" name="trans_type"  value="wallet" id="wallet" />Wallet       
										<input type="radio" name="trans_type"  value="loyality" id="loyality" />Loyality        
										<input type="radio" name="trans_type"  value="discount" id="discount" /> Discount 
...
<!-------******************************************************************************************************************------->
                    ...
                    <div class="box-footer">
                        ...
                        <button type="submit" name="submit" value="create_vouchers" onclick="savemydata()" class="btn btn-primary">
					
					                           
							<i class="fa fa-edit"></i> Create Voucher
								    </button>
                    </div> 
					</form>
            </div><!-- /.box 
