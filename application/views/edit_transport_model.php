        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
				...
				<!--	<div class="form-group">
					   ...
					   <div class="col-md-9">
						<select class="form-control" name="make_id" id="make_id" style=" width:100% auto; ">
							<option value="< ?php echo $trp_vehicle_model->make_id; ?>">< ?php  
								$query2 = $this->db->get_where('trp_vehicle_make', ['id' => $trp_vehicle_model->make_id]);
							...
							echo $make_id; ?>
							< ?php 
								$get_users = $this->db->get('trp_vehicle_make');
								foreach($get_users->result() as $p){
                        ...
                        <div class="form-group <?php if(form_error('model')) echo 'has-error'; ?>">
                            <label for="firstName" class="col-md-3">Vehicle Model</label>
                            <div class="col-md-9"  value="<?php echo set_value('model'); ?>">
                                 <input type="text" name="model" class="form-control" value="<?php echo $model_transport_index->model; ?>" placeholder="">
