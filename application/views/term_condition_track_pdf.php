...
{?>
<br>
<a href="<?php echo base_url('Term_condition/term_condition_track_pdf_export/'.$t->id) ?>" class="btn btn-primary" ><i class="fa fa-file-pdf-o"></i> Download PDF</a>&nbsp;&nbsp;
<a href="<?php echo base_url('Term_condition/term_condition_track_print/'.$t->id) ?>" class="btn btn-primary"  target="_blank" ><i class="fa fa-print"></i> Print</a>&nbsp;&nbsp;
<a href="<?php echo base_url('Term_condition/term_condition_track_view/'.$t->id) ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
