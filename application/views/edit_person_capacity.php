        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Edit Person Capacity</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                ...
                <div class="box-body">
						  ...
						  <div class="form-group <?php if(form_error('capacityperson')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="capacityperson" class="form-control" value="<?php echo $add_capacityperson->capacityperson; ?>" placeholder="">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" name="submit" value="edit_person" class="btn btn-primary">
