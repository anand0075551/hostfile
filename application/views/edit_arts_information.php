...
<?php foreach($arts1->result() as $arts)  ?>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                	...
                	<div class="form-group <?php if (form_error('business_name')) echo 'has-error'; ?>">
								...
								<div class="col-md-9">  								
									...
									<select name="type13" id="type" class="form-control" >
										<option value="<?php echo $arts->type;?>">
										
										<?php 
										$get = $this->db->group_by('type')->get_where('per_art_details');
										$get = $this->db->get_where('per_art_details',['type'=> $arts->type]);
				...
				<div class="form-group <?php if (form_error('text7')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
						<input type="text" name="text7" id="text7" class="form-control" value="<?php echo $arts->text1;?>" placeholder="Enter Text1">	                                
				...
				<div class="form-group <?php if (form_error('text8')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
						<input type="text" name="text8" id="text8" class="form-control" value="<?php echo $arts->text2;?>" placeholder="Enter Text2">	                                
				...
				<div class="form-group <?php if (form_error('text9')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
						<input type="text" name="text9" id="text9" class="form-control" value="<?php echo $arts->text3;?>" placeholder="Enter Text3">	                                
            ...
            <div class="box-footer">
                <button type="submit" name="submit" value="edit_arts" class="btn btn-primary">
                    <i class="fa fa-edit"></i> Update
                </button>
				 
				<button type="submit" name="submit" value="copy_arts" class="btn btn-primary">
                    <i class="fa fa-copy"></i> Copy
                </button> 
				
			 <a href="<?php echo base_url('Personal_info/list_arts_information') ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i>Back</a>	
            </div>
            </form>
        </div><!-- /.box -->
