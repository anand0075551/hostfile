...
<input type="text" readonly name="to_role" value="<?php echo $pay_spec = typeDbTableRow($commissions->to_role)->rolename; ?>" class="form-control" >									
	...
	-->						   </div>
                    ...
                    <div class="box-footer">
                        <button type="submit" name="submit" value="edit_commissions" class="btn btn-primary">
                            <i class="fa fa-edit"></i> Update Commissions    </button>                 
					<a href="<?php echo base_url('ledger/commissions_view/'.$commissions->id ) ?>" class="btn btn-warning"><i class="fa fa-bar-chart"></i> Back </a>	
