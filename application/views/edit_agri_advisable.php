            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group <?php if (form_error('soil_type')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
                            ...
                            <select name="soil_type" id="soil_type" class="form-control" >
                                <option value="<?php echo $edit_agri->soil_type; ?>"></option>
                    ...
                    <div class="form-group <?php if (form_error('soil_type')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
                            ...
                            <select name="weather_tableid" id="weather_tableid" class="form-control" >
                                <option value="<?php echo $edit_agri->weather_tableid; ?>"> Choose option </option>
                    ...
                    <div class="form-group <?php if (form_error('crop')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
                            <input type="text" name="crop" class="form-control" value="<?php echo $edit_agri->crop; ?>" placeholder="Enter Crop Name.">                                
                ...
                <div class="box-footer">
                    <button type="submit" name="submit" value="edit_advisable" class="btn btn-primary">
