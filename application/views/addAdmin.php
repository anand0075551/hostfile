                ...
                <?php echo form_open_multipart('', ['role' => 'form', 'class' => 'form-horizontal']); ?>
                    <div class="box-body">
						...
						<div class="form-group <?php if(form_error('rolename')) echo 'has-error'; ?>">
                            <label for="firstName" class="col-md-3">User/Role Type</label>
                            <div class="col-md-9">
                                <div class="input-group">                          
									<select name="rolename" class="form-control">
										<option value=""> Assign to Role Type </option>										
						...
						<div class="form-group <?php if(form_error('postal_code')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">
                                <input type="number" name="postal_code" maxlength="6"  value="<?php echo set_value('postal_code'); ?>" placeholder="EX: 570555">
...
-->
					...
					<!-- Admin_settings/addAdmin && Settings_models/addAdmin -->
                        <button type="submit" name="submit" value="addAdmin" class="btn btn-primary">
                            <i class="fa fa-edit"></i> Add Administrator
                        </button>
                    </div>
                </form>
            </div><!-- /.box -->
