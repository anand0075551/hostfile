        ...
        <div class="col-md-12">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">All Distribution Commission</h3>
                </div><!-- /.box-header -->
    ...
    <script type="text/javascript">
            $(function () {
                $("#example").dataTable({
                    "processing": true,
                    "serverSide": true,
                    "ajax": "<?php echo base_url('Distributor_commission/commissionListJson'); ?>"
                });
            });
    ...
    <script>
		$('body').on('click', 'a.deleteBtn', function () {
            ...
            if (verifyConfirm) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('Distributor_commission/deleteAjax') ?>",
                    data: {id: agentId},
                })
                        .done(function (msg) {
