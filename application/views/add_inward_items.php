        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header">
                    <h3 class="box-title"> Inward Items</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <?php echo form_open_multipart('', ['role' => 'form', 'class' => 'form-horizontal']); ?>
                    <div class="box-body">
						...
						<div class="form-group <?php if(form_error('from_whom')) echo 'has-error'; ?>">
                            <label for="firstName" class="col-md-3">From Whom
                            ...
                            <div class="col-md-9">
                                <input type="text" name="from_whom" class="form-control"  value="<?php echo set_value('from_whom'); ?>" placeholder="Enter From Whom">
						...
						<div class="form-group <?php if(form_error('to_reciver')) echo 'has-error'; ?>">
                            <label for="firstName" class="col-md-3">To Reciever

                                <span class="text-red">*</span>
                            </label>
                            <div class="col-md-9">
                                <input type="text" name="to_reciver" class="form-control"  value="<?php echo set_value('to_reciver'); ?>" placeholder="Enter To reciver">
					...
					<!-- Admin_settings/addAdmin && Settings_models/addAdmin -->
                        <button type="submit" name="submit" value="inward" class="btn btn-primary">
                            <i class="fa fa-edit"></i> Add Inward Items
