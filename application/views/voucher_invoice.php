                ...
                <div class="box-body">
                    ...
                    <section class="content invoice">
                        ...
                        <div class="row invoice-info">
                            ...
                            <div class="col-sm-4 invoice-col">
                                <b>Transaction Reference No: #<?php echo $invoice->id; ?></b><br/>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                        ...
                        <div class="row">
                            <div class="col-xs-12 table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        <th width="10%">Qty</th>
                                        <th width="40%">Transaction Remarks</th>
                                        <th width="30%">Business Category</th>
                        ...
                        <div class="row no-print">
                            <div class="col-xs-12">
                                ...
                                <a href="<?php echo base_url('voucher_redeem/pdf_invoice/'.$invoice->id) ?>" class="btn btn-primary" ><i class="fa fa-file-pdf-o"></i> Download PDF</a>
                            </div>
                        </div>
                    </section><!-- /.content -->
