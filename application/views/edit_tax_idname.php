            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                        ...
                        <div class="form-group <?php if(form_error('tax_idname')) echo 'has-error'; ?>">
                            <label for="firstName" class="col-md-3">Tax</label>
                            <div class="col-md-9"  value="<?php echo set_value('tax_idname'); ?>">
                                 <input type="text" name="tax_idname" class="form-control" value="<?php echo $tax_id->tax_idname; ?>" placeholder="">
