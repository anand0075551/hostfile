...
<?php foreach($animal1->result() as $animal)  ?>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Pet Animal Detail</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                ...
                <div class="box-body">
                	...
                	<div class="form-group <?php if (form_error('business_name')) echo 'has-error'; ?>">
								...
								<div class="col-md-9">  								
									...
									<select name="type10" id="type" class="form-control" >
										<option value="<?php echo $animal->type;?>">
										
										<?php 
										$get = $this->db->group_by('type')->get_where('per_pet_details');
										$get = $this->db->get_where('per_pet_details',['type'=> $animal->type]);
				...
				<div class="form-group <?php if (form_error('text1')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
						<input type="text" name="text1" id="text1" class="form-control" value="<?php echo $animal->text1;?>" placeholder="Enter Text1">	                                
				...
				<div class="form-group <?php if (form_error('text2')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
						<input type="text" name="text2" id="text1" class="form-control" value="<?php echo $animal->text2;?>" placeholder="Enter Text2">	                                
				...
				<div class="form-group <?php if (form_error('text3')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
						<input type="text" name="text3" id="text3" class="form-control" value="<?php echo $animal->text3;?>" placeholder="Enter Text3">	                                
            ...
            <div class="box-footer">
                <button type="submit" name="submit" value="edit_animal" class="btn btn-primary">
                    <i class="fa fa-edit"></i> Update
                </button>
				<button type="submit" name="submit" value="copy_animal" class="btn btn-primary">
                    <i class="fa fa-copy"></i> Copy
                </button> 
				
			 <a href="<?php echo base_url('Personal_info/list_pet_animal') ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i>Back</a>	
            </div>
            </form>
        </div><!-- /.box -->
