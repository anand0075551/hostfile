...
<html class="bg-black">
    ...
    <body class="bg-white">
        ...
        <div class="form-box" id="login-box">
            <div class="header"><i class="fa fa-leaf"></i><i>   Consumer1st Registrations</i></div>
...
<p><a class="text-center" href="<?php echo base_url(); ?>"><i class="fa fa-info-circle"></i> I already have a membership</a></p>
                    <div class="form-group <?php if(form_error('referredByCode')) echo 'has-error'; ?>">
                        <label for="firstName" class="col-md-3">Referral / Consumer ID
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                <input class="form-control" name="referredByCode" type="text" value="<?php echo set_value('referredByCode'); ?>" placeholder="Consumer ID" />
                            </div>
                    ...
                    <div class="form-group <?php if(form_error('email')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">
                            <input type="email" name="email" class="form-control" value="<?php echo set_value('email'); ?>" placeholder="Please Enter a valid email (user@domain.com)">
                    ...
                    <div class="form-group <?php if(form_error('contactno')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="contactno" class="form-control" value="<?php echo set_value('contactno'); ?>" placeholder="10 Digit Mobile No">
...
<!--
                    ...
                    <div class="form-group <?php if(form_error('rolename')) echo 'has-error'; ?>">
                     ...
                     <div class="col-md-9">
                            <select name="rolename" class="form-control">
								...
								<option value="12" 	<?php echo set_select('rolename', 'customer')    ?>>Volunteer/Consumer</option>								
			...
			-->		
					<div class="form-group <?php if(form_error('id_type')) echo 'has-error'; ?>">
                        <label for="firstName" class="col-md-3">ID Type 
                            <span class="text-red">*</span>
                        </label>
                     <div class="col-md-9">
                            <select name="id_type" class="form-control">
                                <option value=""> Government Id proof should match with your Profile Picture </option>
								<option value="DL">Driving License</option>	
								<option value="PAN No">PAN Number</option>
								<option value="Voter's ID">Voter's ID</option>
								<option value="Aadhaar No">ADHAAR ID</option>
								<option value="Bank Passbook">Bank Passbook</option>
								<option value="College ID">School/College ID</option>
							</select> 							
                            </select>
					...
					<div class="form-group <?php if(form_error('adhaar_no')) echo 'has-error'; ?>">
                        <label for="firstName" class="col-md-3">ID Number        
						<span class="text-red">*</span>
                        </label>
                        <div class="col-md-9">
                            <input type="text" name="adhaar_no" maxlength="40"  value="<?php echo set_value('adhaar_no'); ?>" class="form-control" placeholder="Account will not be 'Activate' for Invalid No">
...
<!--
					...
					<div class="form-group <?php if(form_error('postal_code')) echo 'has-error'; ?>">
                        <label class="text-red" for="firstName" class="col-md-3">Postal Pin/ZIP Code (As per Govt ID,6 digits)
                            <span class="text-red">*</span>
                        </label>
                        <div class="col-md-9">
                            <input type="number"  min="6"  name="postal_code" maxlength="6"  value="<?php echo set_value('postal_code'); ?>" class="form-control" placeholder="EX: 570555">
