<?php 
	...
	foreach($brands->result() as $category); 
                                ...
                                <div class="box-header">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <table class="table table-striped">
											<tr>
                                                <td>Logo</td>
                                                <td><img src ="<?php echo profile_photo_url($category->logo); ?>" width="45" height="50" ></td>
                                            </tr>
											<tr>
                                                <td>Brand Name</td>
                                    ...
                                    <div class="box-footer">
										<a href="<?php echo base_url('Smb_product/physical_product_brands/'.$category->id) ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
                            </div><!-- /.box -->
						</div><!--/.col (left) -->
                    </div>   <!-- /.row -->
                </section><!-- /.content -->
