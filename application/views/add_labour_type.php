        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Add Labour Type</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                ...
                <div class="box-body">
                    ...
                    <div class="form-group <?php if (form_error('zone')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
                            <input type="text" name="zone" class="form-control" value="<?php echo set_value('name'); ?>" placeholder="Enter Zone Name.">                                
                    ...
                    <div class="form-group <?php if (form_error('payment_per_hour')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
                            <input type="number" name="payment_per_hour" class="form-control" value="<?php echo set_value('name'); ?>" placeholder="Enter Payment per hour.">                                
                    ...
                    <div class="form-group <?php if (form_error('half_day_payment')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
                            <input type="number" name="half_day_payment" class="form-control" value="<?php echo set_value('name'); ?>" placeholder="Enter Half Day Payment.">                                
                    ...
                    <div class="form-group <?php if (form_error('full_day_payment')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
                            <input type="number" name="full_day_payment" class="form-control" value="<?php echo set_value('name'); ?>" placeholder="Enter Full Day Payment.">                                
                    ...
                    <div class="form-group <?php if (form_error('overtime_payment')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
                            <input type="number" name="overtime_payment" class="form-control" value="<?php echo set_value('name'); ?>" placeholder="Enter Overtime Payment.">                                
                    ...
                    <div class="form-group <?php if (form_error('fixed_monthly_pay')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
                            <input type="number" name="fixed_monthly_pay" class="form-control" value="<?php echo set_value('name'); ?>" placeholder="Enter Fixed Monthly Pay.">                                
                    ...
                    <div class="form-group <?php if (form_error('incentive')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
                            <input type="number" name="incentive" class="form-control" value="<?php echo set_value('incentive'); ?>" placeholder="Enter Incentive.">                                
                    ...
                    <div class="form-group <?php if (form_error('bonus')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
                            <input type="number" name="bonus" class="form-control" value="<?php echo set_value('bonus'); ?>" placeholder="Enter bonus.">                                
                ...
                <div class="box-footer">
                    <button type="submit" name="submit" value="add_labour_type" class="btn btn-primary">
                        <i class="fa fa-edit"></i>add
                    </button>
					
				<a href="<?php echo base_url('Agriculture/list_labour_type') ?>" class="btn btn-primary"><i class="fa fa-arrow-edit"></i>Back</a>
                </div>
                </form>
            </div><!-- /.box -->
