        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    <a href="<?php echo base_url('Agriculture') ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i>Back</a>
                    <a href="<?php echo base_url('Agriculture/editAgriculture_input_materials/' . $profile->id) ?>" class="btn btn-primary"><i class="fa fa-arrow-edit"></i>Edit</a>
