        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Insert Inward Items</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                ...
                <div class="box-body">
                        ...
                        <label for="firstName" class="col-md-3">Upload Inward Item Photo
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" name="submit" value="copy_inward" class="btn btn-primary">
                        <i class="fa fa-edit"></i> Insert Inward Items
                    </button>
                </div>
                </form>
            </div><!-- /.box -->
