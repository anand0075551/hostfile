        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Edit Vehicle Make</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                ...
                <div class="box-body">
                        ...
                        <div class="form-group <?php if(form_error('brands')) echo 'has-error'; ?>">
                            <label for="firstName" class="col-md-3">Vehicle Brand</label>
                            <div class="col-md-9"  value="<?php echo set_value('brands'); ?>">
                                 <input type="text" name="brands" class="form-control" value="<?php echo $make_transport_index->brands; ?>" placeholder="">
