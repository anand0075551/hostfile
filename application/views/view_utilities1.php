...
<?php
foreach ($utilities1->result() as $profile);
?>
<!-- Main content -->
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
               ...
               <div class="box-footer">
                    <a href="<?php echo base_url('Personal_info/list_utilities1') ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i>Back</a>
