    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group <?php if (form_error('txn_date')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="txn_date" class="form-control some_class" value="<?php echo set_value('txn_date'); ?>" placeholder="">
					 ...
					 <div class="form-group <?php if (form_error('value_date')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="value_date" class="form-control some_class" value="<?php echo set_value('value_date'); ?>" placeholder="">
                    ...
                    <div class="form-group <?php if (form_error('bank_ifsc')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="bank_ifsc" class="form-control" value="<?php echo set_value('bank_ifsc'); ?>" placeholder="">
					...
					<div class="form-group <?php if (form_error('description')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">
                            <textarea name="description" class="form-control" value="<?php echo set_value('description'); ?>" placeholder=""></textarea>
					...
					<div class="form-group <?php if (form_error('cheque_no')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="cheque_no" class="form-control" value="<?php echo set_value('cheque_no'); ?>" placeholder="">
					...
					<div class="form-group <?php if (form_error('branch_code')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="branch_code" class="form-control" value="<?php echo set_value('branch_code'); ?>" placeholder="">
					...
					<div class="form-group <?php if (form_error('debit')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">
                            <input type="number" name="debit" class="form-control" value="<?php echo set_value('debit'); ?>" placeholder="">
					...
					<div class="form-group <?php if (form_error('credit')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">
                            <input type="number" name="credit" class="form-control" value="<?php echo set_value('credit'); ?>" placeholder="">
					...
					<div class="form-group <?php if (form_error('balance')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">
                            <input type="number" name="balance" class="form-control" value="<?php echo set_value('balance'); ?>" placeholder="">
					...
					<div class="form-group <?php if (form_error('remarks')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">
                            <textarea name="remarks" class="form-control" value="<?php echo set_value('remarks'); ?>" placeholder=""></textarea>
            ...
            <div class="box-footer">
                <button type="submit" name="submit" value="bank_transaction" class="btn btn-primary">
