        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Edit Vehical</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                ...
                <div class="box-body">
						  ...
						  <div class="form-group <?php if(form_error('capacityload')) echo 'has-error'; ?>">
                            <label for="firstName" class="col-md-3">Add capacityload
                                <span class="text-red">*</span>
                            </label>
                            <div class="col-md-9">
                                <input type="text" name="capacityload" class="form-control" value="<?php echo $add_capacityload->capacityload; ?>" placeholder="Enter capacityload">
                                <?php echo form_error('capacityload') ?>
                            </div>
                        </div>
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" name="submit" value="edit_capacityload" class="btn btn-primary">
