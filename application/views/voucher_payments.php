        ...
        <div class="col-md-12">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"> Vouchers Transactions Lists </h3>
                </div><!-- /.box-header -->
                <div class="box-body">
    ...
    <script type="text/javascript">
        $(function() {
            $("#example").dataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "<?php echo base_url('voucher_redeem/voucher_paymentListJson'); ?>"
            });
        });
...
<script>
    ...
    $('body').on('click', 'a.deleteBtn', function () {
        ...
        if(verifyConfirm) {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('voucher_redeem/deleteAjax') ?>",
                data: {id: agentId},
            })
            .done(function (msg) {
