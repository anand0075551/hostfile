...
<script type="text/javascript">
	$(function() {
		$("#example").dataTable({
			"processing": true,
			"serverSide": true,
			"ajax": "<?php echo base_url('smb_reports/new_stock_ListJson'); ?>"
		});
	});
...
<script type="text/javascript">
	function search_result()
	{
		...
		var mydata = {"product": product, "vendor": vendor ,"sf_time" : sf_time,"st_time" : st_time};
		
		$.ajax({
			type: "POST",
			url: "<?php echo base_url('smb_reports/stock_search_ListJson'); ?>",
			data: mydata,
