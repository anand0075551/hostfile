			...
			<div class="box-header" style=" box-shadow: 0 2px 4px 0 rgba(0, 0, 0, .23), inset 1px 1px 0 0 hsla(0, 0%, 100%, .2); ">
				...
				<div class="row" style="padding:10px;">
					<div class="col-sm-12 text-left">
						 <a href="<?php echo base_url('Product_preparation/report_warehouse') ?>"> 
			 <button type="button" class="btn btn-success btn-sm btn-flat"  style=" box-shadow: 0 2px 4px 0 rgba(0, 0, 0, .23), inset 1px 1px 0 0 hsla(0, 0%, 100%, .2); "><i class="fa fa-futbol-o"></i>  Available stock</button>
			</a>
						&nbsp;
	...
	$(function() {
		$("#example").dataTable({
			 ...
			 "paging": true,
                  ...
                  "info": true,				  
				  "destroy": true,
			"ajax": "<?php echo base_url('Product_preparation/warehouse_ListJson'); ?>"
		});
	});
