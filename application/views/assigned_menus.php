...
<script type="text/javascript">
	function search_result()
	{
		...
		var mydata = {"bg_id": bg_id,"role_id": role_id};
		...
		$(function() {
            $("#example2").dataTable({
				"paging": true,
                  ...
                  "info": true,
				"ajax": {
            		"url": "<?php echo base_url('menu/leftmenu_search_ListJson'); ?>",
					"type":"POST",
					"data": mydata
       			 }
  ...
  <script>
    ...
    $('body').on('click', 'a.deleteBtn', function () {
        ...
        if(verifyConfirm) {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('menu/deleteAjaxAssignedmenu') ?>",
                data: {id: agentId},
            })
            .done(function (msg) {
	  ...
	  $('body').on('click', 'button.blockUnblock', function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('menu/setBlockUnblock') ?>",
