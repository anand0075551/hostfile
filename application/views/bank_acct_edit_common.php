                ...
                <?php echo form_open_multipart('', ['role' => 'form', 'class' => 'form-horizontal']); ?>
                    <div class="box-body">
                        ...
                        <div class="form-group <?php if(form_error('email')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">
                                <input type="email" name="email" class="form-control" disabled value="<?php echo $profileInfo->email; ?>" placeholder="Enter email">
                        ...
                        <div class="form-group <?php if(form_error('contactno')) echo 'has-error'; ?>">
                            <label for="firstName" class="col-md-3">Account No</label>
                            <div class="col-md-9">
                                <input type="text" name="contactno" class="form-control" value="<?php echo $c_user->account_no; ?>" placeholder="Account No">
                                <?php echo form_error('contactno') ?>
                            </div>
                        </div>
					...
					<!--
						 <div class="form-group <-?php if(form_error('role')) echo 'has-error'; ?>">
                            <label for="firstName" class="col-md-3">Authorization Type</label>
                            <div class="col-md-9">
                                <input type="text" name="role" class="form-control" disabled value="<-?php echo $c_user->role; ?>" placeholder="Authorization Type">
						...
						<div class="form-group <-?php if(form_error('role')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">
                                <select name="role" class="form-control">
                                    ...
                                    <option value="admin" <-?php if($profileInfo->gender == 'admin') echo 'selected'; ?>>Administrator</option>
                                    <option value="user" <-?php if($profileInfo->gender == 'user') echo 'selected'; ?>>Customer</option>
