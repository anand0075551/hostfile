                ...
                <?php echo form_open_multipart('', ['role' => 'form', 'class' => 'form-horizontal']); ?>
                    <div class="box-body">
                        ...
                        <div class="form-group <?php if(form_error('capacityload')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="capacityload" class="form-control" value="<?php echo set_value('capacityload'); ?>" placeholder="Enter capacityload">
					...
					<!-- Admin_settings/addAdmin && Settings_models/addAdmin -->
                        <button type="submit" name="submit" value="capacityload" class="btn btn-primary">
                            <i class="fa fa-edit"></i> Add capacity load
                        </button>
                    </div>
                </form>
            </div><!-- /.box -->
