            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <table class="table table-striped">
									...
									<tr>
										<td>Templet Name</td>
										<td><?php echo $profile->templet_name; ?></td>
									</tr>
									<tr>
										<td>Color</td>
									...
									<tr>
										<td>Content</td>
										<td><?php echo $profile->content; ?></td>
									</tr>
               ...
               <div class="box-footer">
                    <a href="<?php echo base_url('Dashbord_alert/dashbord_alert_index') ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i>Back</a>
...
//							$rolename    = singleDbTableRow($user_id)->rolename;
				...
				<a href="<?php echo base_url('Dashbord_alert/edit_dashbord_alert/' . $profile->id) ?>" class="btn btn-primary"><i class="fa fa-arrow-edit"></i>Edit</a>
