        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Assign To Warehouse</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <?php echo form_open_multipart('', ['role' => 'form', 'class' => 'form-horizontal']); ?>
			 	...
			 	<div class="form-group <?php if (form_error('product_id')) echo 'has-error'; ?>">
								...
								foreach($get_product1->result() as $t){
									$user_name = $t->product;
								$get_declared_name = $this->db->get_where('product_preparation', ['id'=>$user_name]);
									...
									echo "<option value='".$t->product."'>".$declared_name."</option>";
								}
							?>
									</select>
							...
							<div class="form-group <?php if (form_error('assigned_role')) echo 'has-error'; ?>">
								...
								<div class="col-md-9">  								
									...
									<select name="assigned_role"  class="form-control" style="width:100% auto;"onchange="get_user1(this.value)">
										...
										<option value="87"> Main Warehouse Keeper </option>
									</select>	                           
...
<script>
...

	{
		...
		$.ajax({
			type:"POST",
			url:"<?php echo base_url('Product_preparation/get_unique_pack') ?>",
			data:mydata,
	...
	function get_unk_prep(id)
{
	...
	$.ajax({
	 ...
	 $.ajax({
                type: "POST",
				url: "<?php echo base_url('product_preparation/get_button_disabled_asg_main_ware') ?>",
                data: mydata,
                success: function (response) {
