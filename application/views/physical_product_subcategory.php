        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Manage Sub Categories ( Physical Product )</h3>
                </div><!-- /.box-header -->
				<div class="row">
					<div class="col-lg-12 text-right" style="padding-right:30px;"> 
						<a class="btn btn-primary" href="#" data-toggle="modal" data-target="#create_sub_category" data-toggle="modal"><i class="fa fa-plus-circle" aria-hidden="true"></i>  Create Subcategory</a>
					</div>
				</div><hr>
				<div class="box-body">
...
<!-- Create Category -->
<div class="modal fade" id="create_sub_category" role="dialog">
			...
			<div class="row">
				...
				<div class="col-md-12">
					    <div class="box box-primary">
							<div class="box-header">
								<h3 class="box-title"> Add Sub-category ( Physical Product )</h3>
							</div><!-- /.box-header -->
							<!-- form start -->
							...
							<div class="box-body">
								...
								<div class="box-footer text-right">
									<button type="submit" name="submit" value="create_sub_category" class="btn btn-primary">
    ...
    <script type="text/javascript">
        $(function() {
            $("#example").dataTable({
                "processing": true,
                "serverSide": true,	
                "ajax": "<?php echo base_url('Smb_product/subcategory_ListJson'); ?>"
            });
        });
...
<script>                         
    $('body').on('click', 'a.deleteBtn', function () {
        ...
        if(verifyConfirm) {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('Smb_product/sub_deleteAjax') ?>",
                data: {id: agentId},
            })
            .done(function (msg) {
