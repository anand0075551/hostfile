...
<?php
	...
	foreach($template_details->result() as $template); 
                ...
                <?php echo form_open_multipart('', ['role' => 'form', 'class' => 'form-horizontal']); ?>
                    <div class="box-body">
						...
						<div class="form-group <?php if(form_error('template_name')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9" >
									<input class="form-control" name="template_name" id="template_name" type="text" value="<?php echo $template->template_name; ?>" placeholder="Template Name" />
						...
						<div class="form-group <?php if (form_error('pay_type')) echo 'has-error'; ?>">
							...
							<div class="col-md-9">  								
								...
								<select name="pay_type" id="pay_type" class="form-control" style="width:100% auto;">
									<option value="<?php echo $template->pay_type;?>">
											<?php  echo singleDbTableRow($template->pay_type, 'acct_categories')->name; ?>
									</option>
								</select>	                                
						...
						<div class="form-group">
                            <label class="col-md-6" style="font-size:20px;">Default Labels
                             ...
                             <label class="col-md-6" style="font-size:20px;">Modified Labels
                                <span class="text-red"></span>
                            </label>
                        </div>
						...
						<div class="form-group <?php if(form_error('title')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9" >
									<input class="form-control" name="title" id="title" type="text" value="<?php echo $template->title; ?>" placeholder="Title" />
						...
						<div class="form-group <?php if(form_error('date')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9" >
									...
									<input class="form-control" name="date" id="date" type="text" value="<?php echo $template->date;; ?>" placeholder="Date" />
						...
						<div class="form-group <?php if(form_error('sender')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9" >
									...
									<input class="form-control" name="sender" id="sender" type="text" value="<?php echo $template->sender_name; ?>" placeholder="Sender's Name" />
						...
						<div class="form-group <?php if(form_error('receiver')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9" >
									...
									<input class="form-control" name="receiver" id="receiver" type="text" value="<?php echo $template->receiver_name; ?>" placeholder="Receiver's Name" />
						...
						<div class="form-group <?php if(form_error('invoice_no')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9" >
									...
									<input class="form-control" name="invoice_no" id="invoice_no" type="text" value="<?php echo $template->invoice_no; ?>" placeholder="Transaction Reference No" />
						...
						<div class="form-group <?php if(form_error('qty')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9" >
									...
									<input class="form-control" name="qty" id="qty" type="text" value="<?php echo $template->sl_no; ?>" placeholder="Qty" />
						...
						<div class="form-group <?php if(form_error('trans_remark')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9" >
									...
									<input class="form-control" name="trans_remark" id="trans_remark" type="text" value="<?php echo $template->transaction_remarks; ?>" placeholder="Transaction Remarks" />
						...
						<div class="form-group <?php if(form_error('biz_catg')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9" >
									...
									<input class="form-control" name="biz_catg" id="biz_catg" type="text" value="<?php echo $template->business_category; ?>" placeholder="Business Category" />
						...
						<div class="form-group <?php if(form_error('price')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9" >
									...
									<input class="form-control" name="price" id="price" type="text" value="<?php echo $template->price; ?>" placeholder="Price" />
						...
						<div class="form-group <?php if(form_error('subtotal')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9" >
									...
									<input class="form-control" name="subtotal" id="subtotal" type="text" value="<?php echo $template->sub_total; ?>" placeholder="Subtotal" />
						...
						<div class="form-group <?php if(form_error('total')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9" >
									...
									<input class="form-control" name="total" id="total" type="text" value="<?php echo $template->total; ?>" placeholder="Total" />
                        ...
                        <button type="submit" name="submit" id="submit_btn" value="edit_template" class="btn btn-primary" style="display:none;">
                            <i class="fa fa-bookmark-o"></i> Update Template
                        </button>
                    </div>
                    </div><!-- /.box-body -->
