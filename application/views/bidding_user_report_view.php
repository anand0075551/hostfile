...
$currentRolename   = singleDbTableRow($userID)->rolename;
  ...
  <a href="<?php echo base_url('bidding/bidding_user_report/') ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a> </tr>
  <!-- EVENT DETAILS -->
                ...
                <div class="box-body">
                    <table class="table" align="center">
                        ...
                        <tr>
							...
							<td><?php 
							$get_location_name = $this->db->get_where('pincode', ['id'=>$view['location']]);
                            foreach($get_location_name->result() as $l);
                            echo $location = $l->location;
							?></td>
						<tr>
						<tr>
							...
							<td><?php
							 ...
							 echo  singleDbTableRow($view['created_by'])->first_name.' '.singleDbTableRow($view['created_by'])->last_name;
							 ?></td>
						<tr>
...
<section class="content">
    <div class="row">
            ...
            <div class="box">
              ...
              <table id="example" class="table table-bordered table-striped table-hover">
                        ...
                        <tr>
                        	<td><?php echo $cnt;?></td>
                            <td><?php
							if($userID == $eusers['user_id'] )
							{
								$cuser = $eusers['bidding_no'];
								echo 'Me';
							}
							else
							{
								 echo  singleDbTableRow($eusers['user_id'])->first_name.' '.singleDbTableRow($eusers['user_id'])->last_name;
							}
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title" style="color:#3c8dbc"><strong> Chat History </strong></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
              ...
              <table id="example" class="table table-bordered table-striped table-hover">
                        ...
                        <tr>
                        	<td><?php echo $cnt2;?></td>
                            <td><?php
							if($cuser ==$chats['requested_by'] )
							{
								echo 'Me';
							}
							else
							{
							 echo $chats['requested_by'];
							}
							 ?></td>
            ...
            <div class="box">
              ...
              <table id="example" class="table table-bordered table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td><?php
							if($cuser ==$requests['requested_by'] )
							{
								echo 'Me';
							}
							else
							{
							 echo $requests['requested_by'];
							}
							 ?></td>
                            <td><?php 
							if($cuser ==$requests['requested_to'] )
							{
								echo 'Me';
							}
							else
							{
							echo $requests['requested_to'];
							}
							?></td>
            ...
            <div class="box">
              ...
              <table id="example" class="table table-bordered table-striped table-hover">
                        ...
                        <tr>
                        	<td><?php echo $cnt4;?></td>
                            <td><?php 
							if($cuser == $tracks['bidding_user_seller'] )
							{
								echo 'Me';
							}
							else
							{
							echo $tracks['bidding_user_seller'];
							}
							?></td>
                            <td><?php
							if($cuser == $tracks['bidding_user_buyer'] )
							{
								echo 'Me';
							}
							else
							{
							 echo $tracks['bidding_user_buyer'];
							}
							 ?></td>
                            <td><?php 
							if($cuser == $tracks['confirmed_user'] )
							{
								echo 'Me';
							}
							else
							{
							echo $tracks['confirmed_user'];
							}
							?></td>
                           <td><?php echo $tracks['confirmed_amount'];?></td>
                           <td><?php echo $tracks['confirmed_quantity'];?></td>
                           <td><?php 
						   if( $tracks['release_fund'] ==1)
						   {
							   echo 'Yes';
						   }
						   else
