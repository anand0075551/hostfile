                ...
                <?php echo form_open_multipart('', ['role' => 'form', 'class' => 'form-horizontal']); ?>
                    <div class="box-body">
						...
						<div class="form-group <?php // if(form_error('street_address')) echo 'has-error';     ?>">
							...
							<div class="col-md-2">
							<img src ="<?php echo profile_photo_url($sub_category->banner); ?>" width="100" height="80" >
							</div>
							<div class="col-md-7">
                    ...
                    <div class="box-footer">
                        <button type="submit" name="submit" value="update_digital_sub_category" class="btn btn-primary">
                            <i class="fa fa-edit"></i> Update Category
                        </button>
						<a href="<?php echo base_url('Smb_product/update_digital_subcategory/') ?>" class="btn btn-primary">Cancel</a>
                    </div>
                </form>
            </div><!-- /.box -->
        </div><!--/.col (left) -->
