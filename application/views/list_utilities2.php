			...
			<div class="box-header" style=" box-shadow: 0 2px 4px 0 rgba(0, 0, 0, .23), inset 1px 1px 0 0 hsla(0, 0%, 100%, .2); ">
				<div class="row" style="padding:10px;">
					<div class="col-sm-12 text-right">
						...
						&nbsp;
						<button type="button" class="btn btn-primary btn-sm btn-flat" onclick="CSV.begin('#example').download('Utilities2.csv').go()" style=" box-shadow: 0 2px 4px 0 rgba(0, 0, 0, .23), inset 1px 1px 0 0 hsla(0, 0%, 100%, .2); "><i class="fa fa-file-excel-o"></i> Download CSV</button>
					</div>
				</div>
			</div><!-- /.box-header -->
				...
				<div  id="excel_table" class="box-body">
					<table id="example" class="table table-bordered table-striped table-hover print_div">
						...
						<tr>
							...
							<th>RR No.</th>
                            <th>A/C No.</th>
							<th>Current(own/rent/non-rent)</th>
							<th>Address</th>
							<th>Pincode</th>				
							<th>Created At</th>	
							<th>Created By</th>	
	...
	$(function() {
		$("#example").dataTable({
			  ...
			  "paging": true,
                  ...
                  "info": true,				  
				"destroy": true,
			"ajax": "<?php echo base_url('Personal_info/personal_utilities2_ListJson'); ?>"
		});
	});
