...
<?php
foreach ($utilities2->result() as $profile);
?>
<!-- Main content -->
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
						 ...
						 <tr>
                            ...
                            <td><?php echo $profile->servive_orerator; ?></td>
                        </tr>
						 <tr>
                            <td>Account No.</td>
                            <td><?php echo $profile->account_number; ?></td>
                        </tr>
						 <tr>
               ...
               <div class="box-footer">
                    <a href="<?php echo base_url('Personal_info/list_utilities2') ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i>Back</a>
