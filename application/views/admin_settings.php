                ...
                <?php echo form_open('', ['role' => 'form', 'class' => 'form-horizontal']); ?>
                    <div class="box-body">
                        ...
                        <div class="form-group <?php if(form_error('agent_commision')) echo 'has-error'; ?>">
                            <label for="firstName" class="col-md-3">Agent Benefits (On Sales)</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group <?php if(form_error('user_commision')) echo 'has-error'; ?>">
                            <label for="firstName" class="col-md-3">User Benefits (On Puchase)</label>
                            <div class="col-md-9">
                                <div class="input-group">
                        ...
                        <div class="form-group <?php if(form_error('referral_commision')) echo 'has-error'; ?>">
                            <label for="firstName" class="col-md-3">Benefits for Refferal ID</label>  
                            <div class="col-md-9">
                                <div class="input-group">
                                    <div class="input-group-addon">  % </div>
                        ...
                        <div class="form-group <?php if(form_error('admin_commision')) echo 'has-error'; ?>">
                            <label for="firstName" class="col-md-3">Admin Benefits </label>
                            <div class="col-md-9">
                                <div class="input-group">
                                    <div class="input-group-addon"> % </div>
