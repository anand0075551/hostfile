    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <?php echo form_open_multipart('', ['role' => 'form', 'class' => 'form-horizontal']); ?>
					...
					<div class="form-group <?php if (form_error('country')) echo 'has-error'; ?>">
						...
						<div class="form-group <?php if (form_error('district')) echo 'has-error'; ?>">
								...
								<div class="col-md-9">  								
									<input type="text" name="district" class="form-control" value="<?php echo set_value('district'); ?>" placeholder="Enter District.">                                
								...
								<div class="col-md-9">  								
									<input type="text" name="taluk" class="form-control" value="<?php echo set_value('taluk'); ?>" placeholder="Enter taluk.">                                
				...
				<div class="form-group <?php if (form_error('location')) echo 'has-error'; ?>">
					...
					<div class="form-group <?php if (form_error('pincode')) echo 'has-error'; ?>">
								...
								<div class="col-md-9">  								
									<input type="text" name="pincode" class="form-control" value="<?php echo set_value('pincode'); ?>" placeholder="Enter Pincode.">                                
			...
			<div class="form-group <?php if (form_error('postal_region')) echo 'has-error'; ?>">
								...
								<div class="col-md-9">  								
									<input type="text" name="postal_region" class="form-control" value="<?php echo set_value('postal_region'); ?>" placeholder="Enter Postal Region.">                                
					...
					<div class="form-group <?php if (form_error('postal_division')) echo 'has-error'; ?>">
								...
								<div class="col-md-9">  								
									<input type="text" name="postal_division" class="form-control" value="<?php echo set_value('postal_division'); ?>" placeholder="Enter Postal Division.">                                
                    ...
                    <div class="box-footer">
                        <button type="submit" name="submit" value="add_pincode" class="btn btn-primary">
