        ...
        <div class="col-md-12">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"> Tax Slab Index</h3>
                </div><!-- /.box-header -->
...
function page_js() { ?>
    ...
    <script type="text/javascript">
            $(function () {
                $("#example").dataTable({
                    "processing": true,
                    "serverSide": true,
                    "ajax": "<?php echo base_url('Tax_slab/tax_slabListJson'); ?>"
                });
            });
    ...
    <script>
		$('body').on('click', 'a.deleteBtn', function () {
            ...
            if (verifyConfirm) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('Tax_slab/deleteAjax') ?>",
                    data: {id: agentId},
                })
                        .done(function (msg) {
  ...
  $('body').on('click', 'button.blockUnblock', function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('Tax_slab/setBlockUnblock') ?>",
