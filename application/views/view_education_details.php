        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                    ...
                    <table class="table table-striped">
					    <tr>
                            ...
                            <td><?php echo $profile->id; ?></td>
                        	    ...
                        	    <tr>
									<td>Education Details Photo</t> </td>
										<td> 
						...
						<tr>
						 ...
						 <tr>
                            ...
                            <td><?php echo $profile->certificate_no; ?></td>
                        </tr>
						 <tr>
                            <td>Occupation</td>
						...
						<tr>
                            <td>Occupation Document</td>
                            <td><?php echo $profile->occ_document; ?></td>
                        </tr>
               ...
               <div class="box-footer">
                    <a href="<?php echo base_url('Personal_info/list_education') ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i>Back</a>
