                        ...
                        <div class="row invoice-info" style="padding-left:20px; padding-right:20px;">
							...
							<div class="col-sm-6 invoice-col">
								...
								<?php 
									...
									elseif($invoice->payment_type == 'CPA Deduction'){
										$currency = "CPA";
									}
									else{
										$currency = "";
												...
												<tr>
													...
													<td><?php 
														...
														if($get_sts->num_rows() > 0){
															echo singleDbTableRow($row1['id'],'smb_stock')->sac_code;
														}
														else{
															echo singleDbTableRow($row1['id'],'smb_product')->sac_code;
														}
...
?>
                       ...
                       <div>Vendor wise Invoice will be delivered along with the Products.</div>
                    </section><!-- /.content -->
                </div><!-- /.box-body -->
				<?php
