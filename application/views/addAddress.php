        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header">
                    <h3 class="box-title">Add User Address</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                ...
                <div class="box-body">
                    ...
                    <div class="form-group <?php if (form_error('address_type')) echo 'has-error'; ?>">
                        <label for="address_type" class="col-md-3">Address Type
                            <span class="text-red"></span>
                        </label>
                        <div class="col-md-9" >
                            <select name="address_type" id='address_type' class="form-control" onchange="get_address_type(this.value)">
