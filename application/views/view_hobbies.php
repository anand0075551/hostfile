...
<?php
foreach ($hobbies->result() as $profile);
?>
<!-- Main content -->
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
               ...
               <div class="box-footer">
                    <a href="<?php echo base_url('Personal_info/list_hobbies') ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i>Back</a>
