        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Copy Business Group</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
			...
			<div id="voc_div" <?php if($business_groups->voc_permission == '' || $business_groups->voc_permission == 'no'){ ?>style="display:none;" <?php } ?>>				
						...
						<div class="form-group ">
							...
							<div class="col-md-7">
								<input type="file" name="userfile" value="<?php echo $business_groups->image; ?>" class="form-control"  size="20" />
							</div>
						</div>
                    ...
                    <div class="box-footer">
                        ...
                        <button type="submit" name="submit" value="edit_bg" class="btn btn-primary">
                            <i class="fa fa-copy"></i> Copy Business Group name
                        </button>
                    </div>
                </form>
            </div><!-- /.box -->
