            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                         ...
                         <div class="form-group <?php if(form_error('vehicle_type')) echo 'has-error'; ?>">
                            <label for="firstName" class="col-md-3">Add vehicle type
                                <span class="text-red">*</span>
                            </label>
                            <div class="col-md-9">
                                <input type="text" name="vehicle_type" class="form-control" value="<?php echo $add_vehicle->vehicle_type; ?>" placeholder="">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" name="submit" value="edit_vehicle" class="btn btn-primary">
