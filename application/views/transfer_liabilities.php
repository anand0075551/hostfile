                ...
                <?php echo form_open_multipart('', ['role' => 'form', 'class' => 'form-horizontal']); ?>
					...
					<!--
						...
						<div class="form-group <?php if(form_error('pay_type')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">    	
										<input type="radio" name="pay_type"  value="wallet" checked id="type_0" />Cash To Wallet
										<input type="radio" name="pay_type" value="cash" id="type_1" />Wallet To Cash                      
						...
						<div class="form-group <?php if(form_error('cash')) echo 'has-error'; ?>">
								...
								<div class="col-md-9">
									<input type="number" name="cash" step="1" min="0" max="<?php  echo ($wallet_balance); ?>" class="form-control" value="<?php echo set_value('$wallet_balance'); ?>" placeholder="Enter Cash">
