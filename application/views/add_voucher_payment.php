	...
	<?php		$user_info = $this->session->userdata('logged_user');
				...
				$currentRolename   = singleDbTableRow($user_id)->rolename;	?>
						...
						<div class="form-group <?php if(form_error('fname')) echo 'has-error'; ?>">
                            <label for="exampleInputEmail1" class="col-md-3">Voucher Owner Id
                                <span class="text-red">*</span>
                            </label>
                            <div class="col-md-9">
                                <input type="text" name="fname" class="form-control" readonly value="<?php echo $users->pay_by ; ?>" >
                                <?php echo form_error('fname') ?>

                            </div>
                        </div>
						<div class="form-group <?php if(form_error('fname')) echo 'has-error'; ?>">
                            <label for="exampleInputEmail1" class="col-md-3">Voucher Owner's Name
                                <span class="text-red">*</span>
                            </label>
                            <div class="col-md-9">
...
<?php }		?>
				...
				<?php  if ($users->amount <= '1000' and $users->transaction_type == 'Recieve')  {     ?>  
						<div class="form-group <?php if(form_error('to_cell')) echo 'has-error'; ?>">
