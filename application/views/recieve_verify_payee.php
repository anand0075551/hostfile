		...
		<div class="box-body">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Verify Payee to Receive Values</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <?php echo form_open_multipart('', ['role' => 'form', 'class' => 'form-horizontal']); ?>
			        ...
			        <div class="form-group <?php if(form_error('referredByCode')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                <input class="form-control" name="referredByCode" type="text" value="<?php echo set_value('referredByCode'); ?>" placeholder="Consumer Code" />
                            </div>
					...
					-->		
						<div class="form-group <?php if(form_error('amount')) echo 'has-error'; ?>">
                           ...
                           <div class="col-md-9">
                            <!--    <input type="text" name="amount" readonly class="form-control" value="<?php echo amountFormat($wallet_balance); ?>" > -->
							 <input type="number" class="form-control individualPrice" name="amount" step="0.01"  min="0" max="25000" required="" style="width: 100px;" />
						...
						<div class="form-group <?php if(form_error('transaction_type')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">    	
										<!-- <input type="radio" name="transaction_type" value="debit" checked id="type_1" />Transfer   -->
										<input type="radio" readonly name="transaction_type"  value="Recieve" checked id="type_0" />Recieve										
			...
			-->
					...
					<!-- PATH: Product/public function verify_payee and product_model->verify_payee();-->
				      <button type="submit" name="submit" value="receive_verify_payee" class="btn btn-primary">
                            <i class="fa fa-edit"></i> Confirm and Proceed to Verify ConsumerID to Receive Values
							</button>
				  </div>
                </form>
            </div><!-- /.box -->
