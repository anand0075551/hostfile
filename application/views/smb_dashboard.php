		...
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3 id="product">
					<?php
						$get_product = $this->db->get('smb_product');
		...
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3>
				<?php
					$get_sale = $this->db->get_where('smb_sale');
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3>
					<?php
						$vendor=0;
						$get_ven = $this->db->group_by('added_by')->get_where('smb_stock',['type'=>'add']);
		...
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3>
					<?php
						$get_con = $this->db->group_by('buyer')->get('smb_sale');
		...
		<div class="col-sm-6">
			...
			<div class="box box-primary">
				...
				<div class="box-body">
				  ...
				  <h4 class="box-title">
					<?php
						$get_total = $this->db->select_sum('grand_total')->get('smb_sale');
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tbody>
					  <?php
						$get_order = $this->db->order_by('id','desc')->limit(7,0)->get("smb_sale");
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <ul class="products-list product-list-in-box">
                <li class="item">
				<?php
					$get_product = $this->db->order_by('id','desc')->limit(4,0)->get("smb_product");
