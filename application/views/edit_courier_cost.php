            ...
            <div class="box box-primary">
                ...
                <?php echo form_open_multipart('', ['role' => 'form', 'class' => 'form-horizontal']); ?>
                    <div class="box-body">
                            ...
                            <div class="col-md-9" >
                                <div id="weight">
									<input type="text" name="weight" class="form-control" value="<?php echo $courier->weight; ?>" placeholder="Weight (kg)">
								</div>
                        ...
                        <div class="form-group <?php if(form_error('from_pincode')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">
                                <select name="from_pincode" class="form-control" onchange="get_shipper_location(this.value)">
                                    <option value="<?php echo $courier->amount; ?>"> Select Pincode </option>
                                    <?php
						...
						<div class="form-group <?php if(form_error('amount')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9" >
                                <div id="amount">
									<input type="text" name="amount" class="form-control" value="<?php echo $courier->amount; ?>" placeholder="Amount">
								</div>
                    ...
                    <div class="box-footer">
                        <button type="submit" name="submit" value="edit_courier_cost" class="btn btn-primary">
                            <i class="fa fa-edit"></i> Update Shipment Cost
                        </button>
						<a href="<?php echo base_url('courier/shipment_cost_list/'.$courier->id) ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Cancel</a>
                    </div>
                </form>
            </div><!-- /.box -->
