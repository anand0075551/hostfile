            ...
            <div class="box box-primary">
                ...
                <?php echo form_open_multipart('', ['role' => 'form', 'class' => 'form-horizontal']); ?>
                 ...
                 <p><label> Category</label></p>
                       ...
                       <p><label>Item Name</label></p>
							...
							$get_status = $this->db->get_where('inventory_movement', ['product_unique_code'=>$inventory_stocks->product_unique_code]);
				...
				<div class="col-md-4"> 
                 <p><label>Price for Pieces</label></p> 	 								
									<input type="text" name="price_pieces"  class="form-control" onkeyup="get_total()" id="price_pieces" value ="0" readonly >                             
									<?php echo form_error('quantity') ?>
...
?>		
                    ...
                    <div class="box-footer" id="complete_order_div">
						<button type="submit" name="submit" id="submit" value="add_warehouse" onclick="clicked();" class="btn btn-primary">
