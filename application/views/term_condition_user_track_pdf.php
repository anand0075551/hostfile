...
foreach($get_details->result() as $t);
	?>
    <br>
    <a href="<?php echo base_url('Term_condition/term_condition_user_track_pdf_export/'.$ut->id) ?>" class="btn btn-primary" ><i class="fa fa-file-pdf-o"></i> Download PDF</a>&nbsp;&nbsp;
<a href="<?php echo base_url('Term_condition/term_condition_user_track_print/'.$ut->id) ?>" class="btn btn-primary"  target="_blank" ><i class="fa fa-print"></i> Print</a>&nbsp;&nbsp;
<a href="<?php echo base_url('Term_condition/term_condition_user_track_view/'.$ut->id) ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title" style="color:#03F"><?php echo $t->file_name;?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
					<?php 
