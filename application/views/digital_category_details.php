<?php 
	...
	foreach($digital_categgory->result() as $category); 
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    <div class="box-footer">
										<a href="<?php echo base_url('Smb_product/digital_product_category/'.$category->id) ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
                            </div><!-- /.box -->
						</div><!--/.col (left) -->
                    </div>   <!-- /.row -->
                </section><!-- /.content -->
