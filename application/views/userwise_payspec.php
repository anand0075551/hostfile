...
foreach( $userDebit->result()  as $userDebit);
$totaldebit = $userDebit->debit; 

foreach( $userCredit->result() as $userCredit);
$totalcredit = $userCredit->credit; 
        ...
        <div class="col-md-12">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Userwise Accounts Head Consolidated List</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<section class="content">
    <div class="row">
		...
		<input type="button" value="export" onClick="excelData()"/>
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">User wise Pay Specifications Accounts Transaction</h3>
                </div><!-- /.box-header -->
        ...
        $(function() {
            $("#example").dataTable({
              ...
              //  "ajax": "<?php echo base_url('ledger/ledgerListJson'); ?>"
				"ajax": "<?php echo base_url('ledger/userwise_payspecListJson'); ?>"
            });
        });
