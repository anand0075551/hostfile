                            ...
                            <div class="box box-primary">
								...
								if ($query->num_rows() > 0) {
                                    ...
                                    echo "Business Name Doesnot Exist";
                                                ...
                                                <th><?php
															if( $left->active_status == 1 ){
															echo "Active";  } else{ echo "Not Active";}
                                   ...
                                   <!--     <a href="< ?php echo base_url('menu/edit_assigned_menu/'.$left->id) ?>" class="btn btn-primary"><i class="fa fa-edit"></i> Edit</a>-->
										<a href="<?php echo base_url('menu/assigned_menus/'.$left->id) ?>" class="btn btn-primary"><i class="fa fa-edit"></i> Back</a>
                            </div><!-- /.box -->
