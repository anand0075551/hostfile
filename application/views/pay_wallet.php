        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary boxFormContainer">
                <div class="box-header">
                    <h3 class="box-title">Payment Through Wallet</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <?php echo form_open_multipart('', ['role' => 'form', 'class' => 'form-horizontal']); ?>
                    ...
                    <div class="box-footer"> <!--path:  product/ pay_wallet and product_model->pay_wallet -->
                        <button type="submit" name="submit" value="pay_wallet" class="btn btn-primary">
                            <i class="fa fa-edit"></i> Process Transaction
                        </button>
                    </div>
                </form>
            </div><!-- /.box -->
