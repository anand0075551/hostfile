    ...
    <div class="row">
        ...
        <div class="col-md-12">
                ...
                <div class="box-body">
                     ...
                     <div class="form-group <?php if (form_error('voc_name')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								 
							<select name="voc_name" id="voc_name" class="form-control" style="width:100% auto;">
								<option value="<?php echo $voc_generate->voc_name;?>"> 
								<?php 
									if($voc_generate->voc_name != 0){
									echo singleDbTableRow($voc_generate->voc_name, 'status')->status;
									}
									else{
										echo "Choose Option";
									}
					...
					<div class="form-group <?php if (form_error('business_name')) echo 'has-error'; ?>">
								...
								<div class="col-md-9">  								
									...
									<select name="business_name" id="business_name" class="form-control" >
										<option value="<?php echo $voc_generate->business_name;?>">
										
										<?php 
										$get = $this->db->get_where('business_groups', ['id'=>$voc_generate->business_name]);
										foreach($get->result() as $ac);
										echo $ac->id."-".$ac->business_name;
									?> 
					...
					<div class="form-group <?php if (form_error('pay_type')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
                            ...
                            <select name="pay_type" id="pay_type" class="form-control" onchange="get_subcategory(this.value)">
                                <option value="<?php echo $voc_generate->pay_type;?>">
									<?php 
										$get = $this->db->get_where('acct_categories', ['id'=>$voc_generate->pay_type]);
										foreach($get->result() as $ac);
										echo $ac->id."-".$ac->name;
									?> 
								</option>
						...
						<div class="form-group <?php if(form_error('from_pay_type')) echo 'has-error'; ?>">
									...
									<div class="col-md-9" >
										<select name="business_type" id="business_type" class="form-control" onchange="get_account(this.value)">
											<option value="">Choose Option</option>
											<?php
												$query = $this->db->get_where('acct_categories', ['parentid' => '0']);
												foreach($query->result() as $account){
                   ...
                   <div class="form-group <?php if (form_error('paytype_to')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
                            ...
                            <select name="paytype_to" id="paytype_to" class="form-control" onchange="get_subcategory(this.value)">
                                <option value="<?php echo $voc_generate->paytype_to;?>"> 

									<?php 
										$get = $this->db->get_where('acct_categories', ['id'=>$voc_generate->paytype_to]);
										foreach($get->result() as $ac);
										echo $ac->id."-".$ac->name;
									?> 
                    ...
                    <div class="form-group <?php if (form_error('to_role')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
                            ...
                            <select name="to_role"  class="form-control" onchange="get_user(this.value)">
                                <option value="<?php echo $voc_generate->to_role;?>">

									<?php 
										$get = $this->db->get_where('role', ['id'=>$voc_generate->to_role]);
										foreach($get->result() as $ac);
					 ...
					 <div class="form-group <?php if (form_error('to_user')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
							...
							<?php if($voc_generate->to_user != 0){ ?>
                                <option value="<?php echo $voc_generate->to_user;?>">

										<?php 
										$get = $this->db->get_where('users', ['id'=>$voc_generate->to_user]);
										foreach($get->result() as $ac);
                    ...
                    <div class="form-group <?php if (form_error('percentage')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
                            <input type="number" name="percentage" class="form-control" value="<?php echo $voc_generate->percentage;?>" placeholder="Enter percentage.">                                
					 ...
					 <div class="form-group <?php if (form_error('no_of_split')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
                            <input type="number" name="no_of_split" class="form-control" value="<?php echo $voc_generate->no_of_split;?>" placeholder="Enter number split.">                                
					...
					<div class="form-group <?php if(form_error('start_date')) echo 'has-error'; ?>">
								...
								<div class="col-md-9">
									 <input type="text" name="start_date" id="start_date" class="form-control some_class" value="<?php echo $voc_generate->start_date;?>" placeholder="Select Start Date">
							...
							<div class="form-group" id="hrs_gap_div" <?php if($voc_generate->end_date == "0000-00-00"){?>style="display:none"<?php } ?>>
								...
								<?php 
									$datetime1 = new DateTime($voc_generate->end_date);

									$datetime2 = new DateTime($voc_generate->start_date);

									$difference = $datetime1->diff($datetime2);

									$day_gap = $difference->d;
									$hrs_gap = number_format($difference->d*24);
								?>
									<select name="hrs_gap" id="hrs_gap" class="form-control" style="width:100% auto;">
										<option value="<?php echo $hrs_gap ?>"> <?php echo $day_gap." Day (".$hrs_gap." Hours)"; ?> </option>
							...
							<div class="form-group <?php if(form_error('voc_type')) echo 'has-error'; ?>">
								...
								<?php
									$comm1 = $voc_generate->voc_type;
								?>
								<label class="col-md-2"><input type="radio" name="voc_type" <?php if($comm1=="month"){ ?> checked <?php } ?> value="month"> Monthly </label>
								<label class="col-md-2"><input type="radio" name="voc_type" <?php if($comm1=="week"){ ?> checked <?php } ?> value="week"> Weekly </label>
								<label class="col-md-2"><input type="radio" name="voc_type" <?php if($comm1=="day"){ ?> checked <?php } ?> value="day"> Daily </label> &nbsp;&nbsp;
            ...
            <div class="box-footer">
                <button type="submit" name="submit" value="edit_voucher" class="btn btn-primary">
