				 ...
				 <h3 align="center" class="box-title">Please select by above search criteria</h3>	
					...
					<table id="example" class="table table-bordered table-striped table-hover print_div" style="display:none;">
						...
						<tr>
							...
							<th width="10%">Consumer Ph.</th>
							<th width="10%">Consumer Name</th>
...
<script type="text/javascript">
	function search_result()
	{
		...
		var mydata = {"sale_code": sale_code,"sf_date":sf_date,"st_date":st_date,"product":product,"location":location,"vendor":vendor};
		$(function() {	
            $("#example").DataTable({
				 "paging": true,
				  "ordering": true,
				  ...
				  "destroy": true,
				"ajax": {
            		"url": "<?php echo base_url('Smb_allreports/smb_search_ListJson'); ?>",
					"type":"POST",
					"data": mydata
       			 }
            });
