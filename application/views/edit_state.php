            ...
            <div class="box box-primary">
                ...
                <?php echo form_open_multipart('', ['role' => 'form', 'class' => 'form-horizontal']); ?>
                    <div class="box-body">
						...
						<div class="form-group <?php if(form_error('statename')) echo 'has-error'; ?>">
                            <label for="firstName" class="col-md-3">country Abhi
							<span class="text-red">*</span>
							</label>
                            <div class="col-md-9">  								
                                    <input type="text" readonly name="statename" class="form-control" value="<?php  $state->country; 
						...
						<div class="form-group <?php if(form_error('statename')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">  								
                                    <input type="text" name="statename" class="form-control" value="<?php echo $state->statename;?>" placeholder="Enter State Name">                                
                                <?php echo form_error('statename') ?>
                    ...
                    <div class="box-footer">
                        <button type="submit" name="submit" value="edit_state" class="btn btn-primary">
                            <i class="fa fa-edit"></i>Update
                        </button>
						<a href="<?php echo base_url('location/view_state/'.$state->id) ?>" class="btn btn-primary"><i class="fa fa-edit"></i> Cancel</a>
                    </div>
                </form>
            </div><!-- /.box -->
