        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary boxFormContainer">
                <div class="box-header">
                    <h3 class="box-title">Approval for Payment Through Wallet</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <?php echo form_open_multipart('', ['role' => 'form', 'class' => 'form-horizontal']); ?>
                    <div class="box-body">
								...
								<table class="table table-bordered">
								   ...
								   <tr><th> Available Wallet Points			</th> <td> <?php  echo amountFormat($wallet_balance);   ?> 	 </td></tr>
                            ...
                            <div class="row invoice-info">
                                <div class="col-sm-12 invoice-col">
                                    ...
                                    <select name="customerID" class="treeview">

                                        <option value=""> Select Client</option>
                                        <?php foreach($client->result() as $user){
                                            //echo '<option value="'.$user->id.'"> '.user_full_name($user).' </option>';
											 echo '<option value="'.$user->id.'"> '.user_full_name($user).'-'.$user->referral_code.' </option>';
                                        }
                                        ?>
                                ...
                                <div class="col-xs-12 table-responsive">
                                    <table class="table table-striped newProductTable">
                                        ...
                                        <tr class="originalRow">
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="productName"  placeholder="Enter Transaction Comments..." />
                                            </td>
                                            <td>
                                                <select name="sub_account" class="form-control" required="" style="max-width: 200px">
                                                    <option value="">Select Pay Specifications</option>
													<!-- app/control/product  public function sales() for categories-->
                                                <?php
										...
										?>	
                                            ...
                                            <td>
                                        <!--       <input type="number" class="form-control individualPrice" name="price" step="0.01" max="" required="" style="width: 100px;" />
										Goodone 	 <input type="number" class="form-control individualPrice" name="price[]" step="0.01"  max="<?php  echo ($wallet_balance); ?>" required="" style="width: 100px;" />
                                          -->	   <input type="number" class="form-control individualPrice" name="price" step="0.01"  max="<?php  echo ($wallet_balance); ?>" required="" style="width: 100px;" />
                                            </td>
                                            <td>
...
<!--<a href="< ?php echo base_url('dashboard' ) ?>" class="btn btn-warning"><i class="fa fa-bar-chart"></i> Back </a>	

                   path:  product/ wallet_transaction and product_model->wallet_transaction -->
                        <button type="submit" name="submit" value="pay_approval" 
						class="btn btn-danger"><i class="fa fa-mobile "></i> Generate SMS for Approval
                       </button>
                     </div>
                </form>
            </div><!-- /.box -->
