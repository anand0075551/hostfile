        ...
        <div class="col-md-12">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Referral Payments Lists</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
    ...
    <script type="text/javascript">
        $(function() {
            $("#example").dataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "<?php echo base_url('agent/referral_paymentListJson'); ?>"
            });
        });
...
<script>
    ...
    $('body').on('click', 'a.deleteBtn', function () {
        ...
        if(verifyConfirm) {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('agent/referral_payee_deleteAjax') ?>",
                data: {id: agentId},
            })
            .done(function (msg) {
