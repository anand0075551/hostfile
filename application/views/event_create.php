                      ...
                      <div>
                          ...
                          <div class="box-group" id="accordion">
                            ...
                            <div class="panel box box-success">
                              ...
                              <div id="collapseOne" class="panel-collapse collapse in">
								...
								<div class="col-md-9">  								
									<select name="organiser" id="organiser" class="form-control" >
										<option value=""> Choose  </option>
										<?php
										if ($users->num_rows() > 0) 
										{
                        ...
                        <div class="form-group <?php if (form_error('location')) echo 'has-error'; ?>">
                                ...
                                <div class="col-md-9" id="elocation" >  
                                	<select name="location" id="location" class="form-control" onChange="get_users(this.value)" style="width:555px">
                           ...
                           <strong> To :   </strong><select name="sponsor_to" id="sponsor_to" class="form-control"  style="width:555px"><br>
                            ...
                            <div class="panel box box-success">
                              ...
                              <div id="collapseSeven" class="panel-collapse collapse">
								...
								<div class="col-md-9">  								
									<select name="status" id="status" class="form-control" style="width:555px">
	...
	function get_user_by_role(role)
{
    ...
    <!--<script>
	$(document).on('change', 'input[name="open_to_all"]', function() {
    if(this.checked){
		alert('l');
        //this is checked now
    } else {
