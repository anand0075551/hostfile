            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
					...
					<!-- <div class="form-group < ?php if (form_error('type_of_id')) echo 'has-error'; ?>">
                        ...
                        <div class="col-md-9">  								
                            ...
                            <select name="type_of_id"  class="form-control">
                                <option value="< ?php echo $visitor_entry->type_of_id;?>">
									...
									< ?php 
										$get = $this->db->get('visitor_details', ['id'=>$visitor_entry->type_of_id]);
										foreach($get->result() as $ac);
										echo $ac->id."-".$ac->type_of_id;
									?> 
                        ...
                        <label for="firstName" class="col-md-3">Upload visitor Item Photo
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" name="submit" value="copy_visitor" class="btn btn-primary">
                        <i class="fa fa-edit"></i> Insert Visitor Entry
                    </button>
                </div>
                </form>
            </div><!-- /.box -->
