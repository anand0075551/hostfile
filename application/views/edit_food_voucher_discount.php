        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header">
                    <h3 class="box-title">Edit Voucher Discount</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <?php echo form_open_multipart('', ['role' => 'form', 'class' => 'form-horizontal']); ?>
                    <div class="box-body" id="actualprice">
                        ...
                        <div class="form-group <?php if(form_error('food_type')) echo 'has-error'; ?>">
                            <label for="firstName" class="col-md-3">Food type
                                <span class="text-red">*</span>
                            </label>
                            <div class="col-md-9" value="<?php echo set_value('food_type')?>">
                                ...
                                <option value="<?php echo $profile->food_type ?>"><?php 
						...
						<div class="form-group">
                            <label for="firstName" class="col-md-3">Price Per Plate
							 <span class="text-red"></span>
							</label>
                            <div class="col-md-9"> 
								<input type="number" name="actual_price" id="actual_price"  class="form-control" value="<?php echo $profile->actual_value; ?>" placeholder="Price Per Plate" readonly >
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="col-md-4"> 
								<input type="number" name="from_no" min="0"  class="form-control" value="<?php echo $profile->tickent_no_from; ?>" placeholder="Minimum">
                            </div>
							<div class="col-md-1 text-center" style="padding-top:7px;"> 
								<i class="fa fa-minus"></i>
                            </div>
							<div class="col-md-4"> 
								<input type="number" name="to_no" min="0" class="form-control" value="<?php echo $profile->tickent_no_to; ?>" placeholder="Maximum">
                            </div>
                        </div>
                        ...
                        <div class="form-group <?php if(form_error('discount_%')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">
                                <input type="number" name="discount_%"  id="discount_per" class="form-control" value="<?php echo $profile->discount_in_per; ?>" onkeyup="abcd(this.value)">
                        ...
                        <div class="form-group <?php if(form_error('discount_value')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">
                                 <input type="number" name="discount_value" id="discount_value" placeholder="Discount Value" class="form-control" value="<?php echo $profile->discount_value; ?>" placeholder="" readonly >
                        ...
                        <div class="form-group <?php if(form_error('price_discount')) echo 'has-error'; ?>">
                            ...
                            <div class="col-md-9">
                                <input type="number" name="price_discount" placeholder="Price After Discount" id="price_discount" class="form-control"  value="<?php echo $profile->price_after_discount; ?>" placeholder="" readonly>
					...
					<!-- Admin_settings/addAdmin && Settings_models/addAdmin -->
                        <button type="submit" name="submit" value="foodvoucher" class="btn btn-primary">
                            <i class="fa fa-edit"></i> Update Voucher Discount
                        </button>
                    </div>
                </form>
            </div><!-- /.box -->
