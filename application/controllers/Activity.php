	...
	public function activityJsonApi(){
		...
		if($this->input->get('showFor')){
			...
			if($showFor == 'allUsers'){
				...
				$query = $this->user_model->activityList_user($limit, $start);
				...
				$query = $this->user_model->activityList_alluser($limit, $start);
		...
		//	$query = $this->user_model->activityList_session_user($limit, $start);
