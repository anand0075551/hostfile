...
class Inventory_stocks extends CI_Controller {
	...
	$data['title'] = $this->db->get(' smb_product');
        ...
        if ($this->input->post()) {
            ...
            if ($this->form_validation->run() == true) {
                $insert = $this->Product_preparation_model->add_inventory_new();
                if ($insert) {
	...
	/*======================================================================*/
	  ...
	  public function get_wght()
     {
         $to_role=$_POST['id'];
        // echo $to_role;
         $query = $this->Inventory_stocks_model->get_wght($to_role);
	 ...
	 // get volume
	  ...
	  public function get_wght1()
     {
         $to_role=$_POST['id'];
        // echo $to_role;
         $query = $this->Inventory_stocks_model->get_wght1($to_role);
