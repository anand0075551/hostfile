...
$insert = $this->Api_model->paymentAPI();
				if($insert)
				{
					
					echo "'C1st CCB'Your Payment Transfer has been Completed Successfully...!!!";

                                        echo "' !!!!...Data Fetching from Live Portal...!!!";
				}else{
...
//Api for Restorent payment
public function payment2()
{


$insert = $this->Api_model->paymentAPI_resto();
				if($insert)
				{
					
					echo "'Restaurant Payment Transfer Request Submitted Successfully...!!!";
